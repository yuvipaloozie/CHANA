...
def _validator_module():
    ...
    path = root / "scripts" / "validate_manifests.py"
    spec = importlib.util.spec_from_file_location("validate_manifests", path)
...
def _write_registry(directory: Path):
    pd.DataFrame(
        [["unet_baseline", "unet", "baseline", "unet.h5", "legacy.h5", 1, "a" * 64, "test-env"]],
        columns=[
...
def test_model_registry_validates():
    root = Path(__file__).resolve().parents[1]
...
def test_pseudolabel_teacher_is_registered_separately_from_evaluation_models():
    root = Path(__file__).resolve().parents[1]
    registry = pd.read_csv(root / "manifests" / "model_registry.csv").set_index("model_id")
...
def test_primary_model_ids_are_bound_to_hash_verified_regimes():
    ...
    expected = {
        "unet_baseline": (
            "unet_baseline.weights.h5", "Unet_DenseNet_Domain.weights.h5",
            "00e22d5af8ac21353f5d30cf9711d89f5902c7a9968dce9481507dccee2875f2",
        ),
        "unet_curriculum": (
            "unet_curriculum.weights.h5", "Unet_DenseNet_no_Domain.weights.h5",
            "020aef4a35d38a6251530acfde8cbdca9a3487a2f7e17ffc7a45391589b26498",
        ),
        "unetpp_baseline": (
            "unetpp_baseline.weights.h5", "UNetPlusPlus_Domain.weights.h5",
            "271c2d90dde658853615037aa1fb7158d5b0d8a9a48c30dd0a7989b3418573e4",
        ),
        "unetpp_curriculum": (
            "unetpp_curriculum.weights.h5", "Unetplusplus_no_Domain.weights.h5",
            "a9a18e22455bfb20caddb5f714b7290ba3e020f8863702977606d44768e3dcfd",
        ),
        "transunet_baseline": (
            "transunet_baseline.weights.h5", "transunet_domain.weights.h5",
            "d0927f39a307f69b541113fbfb23781c06c0b9ee853efe2f11836e67bb196fa1",
        ),
        "transunet_curriculum": (
            "transunet_curriculum.weights.h5", "transunet_no_domain.weights.h5",
